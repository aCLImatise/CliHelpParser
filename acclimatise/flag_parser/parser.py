...
class CliParser:
    ...
    def __init__(self, parse_positionals=True):
        ...
        self.description = self.indented_desc  # Optional(one_line_desc) + Optional(indented_desc)
        ...
        self.positional = (cli_id + self.description).setName('positional').setParseAction(
